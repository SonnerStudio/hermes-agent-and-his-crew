...
- **Composer Control Buttons** — ארבעה כפתורי מצב בקומפוזר שולחני עם צבעי מצב בזמן אמת (אדום = לא פעיל, צהוב = הכנה, ירוק = פעיל) :
  1. **הפעל תת-סוכנים** — מפעיל תת-סוכני AI מומחים שקונים תת-משימות באופן אוטונומי, כל אחד עם יכולות המומחיות שלו, ולומדים ברציפות ממשימות ולאורך זמן.
  2. **מזכירה** — מנהלת הסוכנים: מתכננת ומקצה משימות, וכמתקשרת מספקת מצב דיבור (קלט/פלט קולי) עם אודיו באיכות קולנועית (Kokoro `df_eva`, מהירות 0.9).
