...
<p align="center">
  ...
  <a href="README.ja.md"><img src="https://img.shields.io/badge/Lang-%E6%97%A5%E6%9C%AC%E8%AA%9E-red?style=for-the-badge" alt="日本語"></a>
...
- **Composer コントロールボタン** — デスクトップのコンポーザー内にある 4 つのトグルボタン（サブエージェントオーケストレーション、音声通信、オーケストレーション、ダブルモード）。状態に応じたライブカラー付き（赤 = 無効、黄 = 準備中、緑 = 有効）。
