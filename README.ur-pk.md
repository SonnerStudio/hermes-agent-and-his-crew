...
- **Composer Control Buttons** — ڈیسک ٹاپ کمپوزر میں لائیو حالت کے رنگوں (سرخ = غیر فعال، پیلا = پروویژننگ، سبز = فعال) کے ساتھ چار ٹوگل بٹن :
  1. **ذیلی ایجنٹس فعال کریں** — خصوصی AI ذیلی ایجنٹس کو فعال کرتا ہے جو خودکار طور پر ذیلی کام سنبھالتے ہیں، ہر ایک اپنی مہارت کے ساتھ، اور کاموں سے اور وقت کے ساتھ مسلسل سیکھتے ہیں۔
  2. **سیکریٹری** — ایجنٹس کی منیجر: کاموں کی منصوبہ بندی کرتی ہے اور انہیں تفویض کرتی ہے، اور ایک مواصلاتی کے طور پر فلمی معیار کی آڈیو (آواز ان پٹ/آؤٹ پٹ) فراہم کرتی ہے (Kokoro `df_eva`، رفتار 0.9)۔
